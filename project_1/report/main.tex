...
% We trained for 50 epochs. Figure~\ref{fig:train_curve} shows the training and validation accuracy curves. Our final model achieves XX\% accuracy on the held-out test set.
